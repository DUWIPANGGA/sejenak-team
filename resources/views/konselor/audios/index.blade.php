...
<div class="container mx-auto px-6 py-8">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8">
        ...
        <a href="{{ route('konselor.audios.create') }}" class="mt-4 sm:mt-0 inline-block px-6 py-3 bg-primary text-white font-bold text-center rounded-playful-sm border-2 border-dark shadow-border-offset hover:bg-green-600">
