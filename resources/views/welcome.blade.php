    ...
    <div class="flex flex-col items-center h-full w-full overflow-x-hidden no-scrollbar z-10">
        <section class="w-[100%] py-20 flex flex-col md:flex-row items-center justify-between gap-8 bg-primary">
            <div class="md:w-1/2 flex flex-row justify-center align-bottom items-end gap-6">
            ...
            <div class="md:w-1/2 flex flex-col items-center md:items-start text-center md:text-left">
                <h1 class="text-4xl md:text-4xl lg:text-5xl font-extrabold text-black leading-relaxed mb-4">
        ...
        <section id="second-layer" class="flex flex-col lg:flex-row gap-8 justify-center items-center py-20 px-8 lg:px-60 w-full">
        ...
        <section id="features" class="w-full bg-[url('assets/component/bg-third.svg')] flex justify-center">
        ...
        <section id="pricing" class="w-full flex justify-center my-12 py-12 text-center">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 px-4 md:px-0 lg:px-20">
                {{-- KARTU 1 (FREE) --}}
                <div class="card w-full md:w-1/2 p-6 bg-[url('assets/component/price_container1.svg')] bg-no-repeat bg-contain rounded-xl transform transition-transform hover:scale-105 hover:translate-y-[-10px] flex flex-col justify-between">
                    <div class="container">
                        <h1 class="text-xl md:text-5xl font-bold text-black mb-2 animate-rotate-slow">Free</h1>
                    </div>
                    <div class="container">
                        <p class="text-5xl font-extrabold text-black mb-4 animate-rotate-slow">
                            $0<span class="text-lg font-normal">/month</span>
                        </p>
                        <ul class="text-left text-black mb-6 list-disc list-inside space-y-2">
                            <li class="animate-rotate-slow">Access to public forums</li>
                            <li class="animate-rotate-slow">Basic journaling features</li>
                            <li class="animate-rotate-slow">Limited guided activities</li>
                        </ul>
                        <a href="{{ route('login') }}" class="block py-2 px-6 rounded-full text-black font-bold bg-white border-2 border-primary shadow-border-offset-accent transition-all duration-300 hover:transform hover:translate-y-[-5px] hover:shadow-[5px_5px_0_#8FD14F]">
                            Join for Free
                        </a>
                    </div>
                </div>
                ...
                {{-- KARTU 2 (PREMIUM) --}}
                <div class="card p-6 bg-[url('assets/component/price_container2.svg')] bg-no-repeat bg-contain rounded-xl transform transition-transform hover:scale-105 hover:translate-y-[-10px] flex justify-end aspect-[5/3] overflow-hidden">
                    <div class="w-full flex flex-row items-start justify-between">
                        <div class="flex-1 flex flex-col items-start text-left ml-10">
                            <h3 class="text-xl md:text-2xl font-bold text-black mb-2 animate-rotate-slow">Premium</h3>
                            <p class="text-black text-sm mb-4">Unlock the full experience.</p>
                            <p class="text-4xl font-extrabold text-black mb-4 animate-rotate-slow">
                                $9.99<span class="text-lg font-normal">/month</span>
                            </p>
                            <ul class="text-left text-black mb-6 list-disc list-inside space-y-2">
                                <li class="animate-rotate-slow">All Free features</li>
                                <li class="animate-rotate-slow">Unlimited private journaling</li>
                                <li class="animate-rotate-slow">Full library of guided activities</li>
                                <li class="animate-rotate-slow">Connect with mental health professionals</li>
                            </ul>
                            <a href="{{ route('login') }}" class="py-2 px-6 rounded-full text-white font-bold bg-secondary border-2 border-black shadow-border-offset transition-all duration-300 hover:transform hover:translate-y-[-5px] hover:shadow-[5px_5px_0_#080330]">
                                Go Premium
                            </a>
                        </div>
                    </div>
        ...
        <section id="cta-section" class="w-full h-full flex justify-center py-20 bg-primary bg-dot-pattern">
            <div class="w-full md:w-[70%] text-center md:text-left p-8">
    ...
    <style>
        ...
        .animate-rotate-slow {
            ...
            transform-origin: center center; /* Memastikan rotasi dari tengah */
        }
